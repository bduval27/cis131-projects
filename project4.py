'''
script: Project 3(4?): Data Analysis
...
def sortStudentListByLastName(studentList):
    studentList.sort(key = lambda student: student._lastName)
...
def createMenu(employeeList, studentList):
    ...
    while True:
        ...
        if menuInput < 1 or menuInput > 10: # can easily be changed later to utilize and else statement, but it looks like this for now
